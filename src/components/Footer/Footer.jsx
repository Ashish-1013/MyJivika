...
//         {/* Brand Info */}
//         <div>
//           <h2 className="text-3xl font-extrabold text-yellow-400 tracking-wide">My Jivika</h2>
...
//             <a href="https://myjivika.com" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition"><FaGlobe size={22} /></a>
//             <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition"><FaTwitter size={22} /></a>
//             <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition"><FaFacebookF size={22} /></a>
//             <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition"><FaInstagram size={22} /></a>
//             <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400 transition"><FaLinkedinIn size={22} /></a>
//           </div>
//         </div>

//         {/* Quick Links */}
//         <div>
//           <h3 className="text-xl font-semibold mb-4 border-b border-yellow-400 pb-2 w-fit">Quick Links</h3>
...
//             <li><a href="#guidance" className="hover:text-yellow-400 transition">Career Guidance</a></li>
//             <li><a href="#employers" className="hover:text-yellow-400 transition">Employers</a></li>
//           </ul>
//         </div>

//         {/* Resources */}
//         <div>
//           <h3 className="text-xl font-semibold mb-4 border-b border-yellow-400 pb-2 w-fit">Resources</h3>
//           <ul className="space-y-2 text-gray-200 text-sm">
//             <li><a href="#blog" className="hover:text-yellow-400 transition">Blog</a></li>
//             <li><a href="#faqs" className="hover:text-yellow-400 transition">FAQs</a></li>
...
//         {/* Contact */}
//         <div>
//           <h3 className="text-xl font-semibold mb-4 border-b border-yellow-400 pb-2 w-fit">Contact Us</h3>
//           <div className="text-gray-200 text-sm space-y-1">
//             <p><span className="font-bold">Address:</span> Bhubaneswar, Odisha, India</p>
//             <p><span className="font-bold">Email:</span> <a href="mailto:support@myjivika.com" className="hover:text-yellow-400 transition">support@myjivika.com</a></p>
//             <p><span className="font-bold">Phone:</span> <a href="tel:+919876543210" className="hover:text-yellow-400 transition">+91 98765 43210</a></p>
//           </div>
//           <a href="#contact" className="inline-block mt-5 px-5 py-2 bg-yellow-400 text-blue-900 font-semibold rounded-full shadow hover:bg-yellow-300 transition duration-200">
//             Get in Touch
//           </a>
//         </div>
//       </div>
...
//         <div className="bg-blue-800 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between shadow-lg">
//           <div className="mb-4 md:mb-0">
//             <h4 className="text-lg font-bold text-yellow-400">Subscribe to our Newsletter</h4>
//             <p className="text-gray-200 text-sm">Get the latest updates, jobs, and courses delivered to your inbox.</p>
//           </div>
//           <form className="flex w-full md:w-auto">
//             <input
//               type="email"
//               placeholder="Your email address"
//               className="rounded-l-full px-4 py-2 text-blue-900 focus:outline-none"
//               required
//             />
//             <button
//               type="submit"
//               className="bg-yellow-400 text-blue-900 font-semibold px-5 py-2 rounded-r-full hover:bg-yellow-300 transition"
//             >
//               Subscribe
//             </button>
//           </form>
...
//           <span className="text-yellow-400">Hemant Suna</span>, and{" "}
//           <span className="text-yellow-400">Dinesh Mahanta</span>. */}
//         </p>
//       </div>
//     </footer>
//   );
